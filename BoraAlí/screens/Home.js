...
const Home = ({ navigation, route }) => {
  ...
  const dataInicial = [
    ...
    {
      id: 2,
      textHeading: 'O que a Recife',
      textSubheading: 'Museus,.',
      textParagraph: 'Tudo que a cidade tem de bom pra você!',
      imageSource: require('../assets/ruadobomjesus.png'),
    },
    {
      id: 3,
      textHeading: 'Outra ',
      textSubheading: 'Outro ',
      textParagraph: 'Outra d',
            ...
            <View style={styles.content}>
              ...
              <TouchableOpacity style={styles.button} onPress={handleContinue}>
                <Text style={styles.buttonText}>
                  {currentId === dataInicial.length - 1 ? 'Finalizar' : 'Continuar'}
                </Text>
              </TouchableOpacity>
